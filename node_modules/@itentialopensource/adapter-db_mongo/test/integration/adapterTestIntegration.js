...
describe('[integration] Mongo Adapter Test', () => {
  describe('Mongo Class Tests', () => {
    ...
    */
    ...
    const myData = { test: `test1${randExt}`, start: '2019-11-12T00:00:00Z' };
    let myDataId = '0';
    ...
    const replaceData = { $set: { addField: 'added data' } };
    ...
    const updateData = { $set: { addField: 'changed added data' } };
